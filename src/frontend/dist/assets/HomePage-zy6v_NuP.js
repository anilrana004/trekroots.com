import { r as reactExports, j as jsxRuntimeExports, m as motion, L as Link, A as ArrowRight, S as Star, M as Mountain, a as Shield, U as Users, b as MapPin, C as Clock } from "./index-B8T7PWVC.js";
import { A as ArrowLeft } from "./arrow-left-0AB5wqTQ.js";
const CAROUSEL_ITEMS = [
  {
    ...
    duration: "6 Days",
    altitude: "3,962 m",
    tagline: "A monsoon meadow of 300+ Himalayan wildflower species — UNESCO World Heritage.",
  ...
  },
  {
    ...
    duration: "6 Days",
    altitude: "3,811 m",
    tagline: "India's finest winter trek — a snow-clad summit at sunrise above the clouds.",
  ...
  },
  {
    ...
    duration: "8 Days",
    altitude: "5,029 m",
    tagline: "The mysterious Skeleton Lake sits atop a dramatic glacial ridge at 5,000 m.",
  ...
  },
  {
    ...
    duration: "12 Days",
    altitude: "3,583 m",
    tagline: "Walk the four sacred shrines of Uttarakhand — a journey of a lifetime.",
  ...
  },
  {
    ...
    duration: "4 Days",
    altitude: "3,583 m",
    tagline: "Lord Shiva's high abode — one of the 12 Jyotirlingas in the Himalayas.",
...
const REVIEWS = [
  {
    id: 1,
    quote: "Every detail was handled with such care. The Kedarkantha summit at sunrise, surrounded by snow-laden pines, is a memory I'll carry forever.",
    name: "Arjun Mehta",
  ...
  {
    id: 2,
    quote: "The Char Dham Yatra with Manya was transcendent. Their expert guides made the spiritual journey as smooth as it was profound.",
    name: "Priya Sharma",
  ...
  {
    id: 3,
    quote: "Spiti Valley left me speechless. Manya's local knowledge opened doors — remote monasteries, hidden villages — that no other operator offered.",
    name: "Vikram Nair",
    location: "Delhi, NCR",
...
const ARTICLES = [
  {
    ...
    excerpt: "Everything you need — gear, fitness prep, itinerary, what to expect on the summit.",
    readTime: "8 min read",
    image: "/assets/generated/trek-kedarkantha.dim_800x600.jpg"
  },
  {
    ...
    excerpt: "How to register, what to carry, which season to go, and how to make the most of your pilgrimage.",
  ...
  },
  {
    ...
    excerpt: "Monasteries, permits, road conditions, best stays — a practical guide to the cold desert.",
...
function SectionTitle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "h2",
    {
      className: `font-display text-[36px] md:text-[48px] font-bold leading-[1.1] mb-5 ${centered ? "text-center" : ""}`,
...
function SubSectionHeading({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start mb-6", children: [
...
function TrekCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.slug, "data-ocid": `treks.item.${index + 1}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { height: "280px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: item.image,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(180deg, transparent 40%, rgba(28,10,10,0.9) 100%)"
              }
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-[11px] font-body text-white/70", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, style: { color: "#C04000" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
...
function YatraCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      className: "group rounded-2xl overflow-hidden cursor-pointer flex-shrink-0 w-[280px] md:w-auto",
      style: { boxShadow: "0 2px 16px rgba(60,20,20,0.08)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.slug, "data-ocid": `yatras.item.${index + 1}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { height: "300px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: item.image,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0",
              style: {
                background: "linear-gradient(180deg, transparent 35%, rgba(60,20,20,0.92) 100%)"
              }
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-body text-white/60", children: item.temples })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, style: { color: "#ED872D" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "font-body text-[12px]",
...
function HeroCarousel() {
  ...
  reactExports.useEffect(() => {
    timerRef.current = setTimeout(goNext, 5e3);
    return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        CAROUSEL_ITEMS.map((slide, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "absolute inset-0",
                  style: {
                    background: "linear-gradient(180deg, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0.04) 35%, rgba(0,0,0,0.68) 100%)"
                  }
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 flex flex-col justify-end pb-20 px-6 md:px-16 max-w-[1200px] mx-auto left-0 right-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      backgroundColor: item.category === "YATRA" ? "#ED872D" : "#E6BE8A",
                      color: "#3C1414"
                    },
                    children: item.category
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white/60 font-body text-[12px] uppercase tracking-widest", children: [
                  item.duration,
                  " • ",
                  item.altitude
                ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  children: [
                    "Explore ",
                    item.category === "YATRA" ? "Yatra" : "Trek",
                    " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 18, color: "white" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 18, color: "white" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2.5", children: CAROUSEL_ITEMS.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => goTo(i),
            ...
            style: {
              ...
              height: "8px",
              backgroundColor: i === current ? "#E6BE8A" : "rgba(255,255,255,0.45)"
            }
          },
          `dot-${i}`
        )) })
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { backgroundColor: "#FAFAF7" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-6 max-w-[860px] mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: "Uttarakhand • Himachal Pradesh"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.h1,
              {
                ...
                children: "Journeys That Stay With You Forever"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: "Expert-guided treks, sacred yatras, and handcrafted Himalayan experiences — from our family to yours."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: PAGE_STATS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-white/70 text-[10px] tracking-wide uppercase", children: s.label })
                  ] }, s.label))
                }
              )
            }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 24 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Simple Process" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { centered: true, children: "How It Works" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "font-body text-[16px] leading-relaxed mx-auto",
                    style: { maxWidth: "480px", color: "#7A7A7A" },
                    children: "From choosing your adventure to summiting the peak — we handle every detail."
                  }
                )
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                i < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    "aria-hidden": true,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 12, color: "#3C1414" })
                  }
                )
              ]
            },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto", children: [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Curated Experiences" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SubSectionHeading, { children: "Featured Treks" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "font-body text-[15px]",
                      style: { color: "#7A7A7A", maxWidth: "440px" },
                      children: "Snow-dusted winter trails, monsoon meadows, and granite ridgelines — the finest Himalayan treks, curated for all levels."
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: FEATURED_TREKS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrekCard, { item, index: i }, item.id))
            }
          )
        ] })
      }
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Curated Experiences" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SubSectionHeading, { children: "Sacred Yatras" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "font-body text-[15px]",
                      style: { color: "#7A7A7A", maxWidth: "440px" },
                      children: "Ancient temples, holy rivers, and divine Himalayan abodes — guided pilgrimages that nourish the soul."
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "flex gap-5 overflow-x-auto pb-4 md:pb-0 md:grid md:grid-cols-4 md:overflow-visible -mx-6 px-6 md:mx-0 md:px-0",
              style: { scrollbarWidth: "none" },
              children: FEATURED_YATRAS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(YatraCard, { item, index: i }, item.id))
            }
          )
        ] })
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1400px] mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-0 divide-x divide-white/10", children: PAGE_STATS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 20 },
            whileInView: { opacity: 1, y: 0 },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "text-center mb-16",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Voices from the Trail" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { centered: true, children: "What Our Travellers Say" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mt-2", children: [
                  [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16, fill: "#E6BE8A", color: "#E6BE8A" }, s)),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: REVIEWS.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 28 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 mb-5", children: Array.from({ length: t.rating }).map((_, si) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                    size: 13,
                    fill: "#E6BE8A",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1400px] mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-5 gap-4", children: [
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { size: 20 }),
        ...
        ].map((badge, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 16 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#C04000" }, children: badge.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        className: "py-20 px-6",
        style: { backgroundColor: "#3C1414" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1400px] mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "Plan Your Himalayan Journey"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Get seasonal trek updates, yatra opening dates, weather advisories and exclusive early-bird deals."
                  }
                ),
                subscribed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16, fill: "#E6BE8A", color: "#E6BE8A" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-body text-[13px] font-medium",
                          style: { color: "#E6BE8A" },
                          children: "You're in! Watch your inbox for Himalayan updates."
                        }
                      )
                    ]
                  }
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Talk to a Himalayan travel expert. Free 30-minute consultation — no commitment required."
                  }
                ),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Stories from the Mountains" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "Travel Guides & Insights" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: ARTICLES.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 28 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: post.slug, className: "group block", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
