import { useYatraBySlug } from "@/hooks/useBackendQuery";
    ...
    reviews: [
      {
        ...
        state: "Maharashtra",
        rating: 5,
        text: "Manya Destination made our Char Dham trip absolutely seamless. The guide was knowledgeable about every temple ritual. Our family of 6 felt completely safe throughout.",
        date: "October 2024",
      },
      {
        name: "Rajesh Kumar",
...
export default function YatraDetailPage() {
  ...
  const { data: yatra, isLoading } = useYatraBySlug(slug);
    ...
    return (
      ...
      >
        <div className="text-center px-4">
          ...
          <p className="font-body text-base mb-8" style={{ color: "#7A7A7A" }}>
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FAFAF7" }}>
      ...
      <div data-hero className="relative h-[80vh] overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(60,20,20,0.18) 0%, rgba(60,20,20,0.72) 100%)",
          }}
        />
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-14 md:px-16">
          <div className="max-w-[1400px] mx-auto">
            ...
            >
              ...
              <span>/</span>
              <Link to="/yatra" className="hover:text-white transition-colors">
                Yatra
              </Link>
              <span>/</span>
              <span style={{ color: "#E6BE8A" }}>{yatra.name}</span>
            </nav>
            {/* Tagline */}
            <p
      ...
      <div
        ref={navRef}
        className={`sticky top-[68px] z-30 transition-shadow ${navSticky ? "shadow-md" : ""}`}
        style={{
          ...
          <div className="flex gap-0 min-w-max">
            {SECTIONS.map((s) => (
              <button
                ...
                className="px-4 py-4 text-xs font-body font-semibold tracking-wide uppercase transition-colors whitespace-nowrap"
                style={{
                  color: activeSection === s ? "#3C1414" : "#7A7A7A",
                  borderBottom:
                    activeSection === s
                      ? "2px solid #3C1414"
        ...
        <div className="space-y-16 min-w-0">
          ...
          >
            ...
            {enrichment.mythologicalRef && (
              <div
                ...
                style={{ borderLeft: "3px solid #E6BE8A" }}
              >
                <p
          ...
          >
            ...
            >
              <Info
                ...
                style={{ color: "#ED872D" }}
              />
              <p className="font-body text-xs" style={{ color: "#4A4A4A" }}>
                All puja bookings coordinated by Manya Destination. Book via
          ...
          >
            ...
            >
              <table className="w-full text-sm font-body">
                <thead>
                  <tr style={{ backgroundColor: "#3C1414" }}>
                    {[
                      "Season / Period",
                      "Morning Aarti",
                      "Darshan Hours",
                ...
                <tbody>
                  {enrichment.templeSchedule.map((row, i) => (
                    <tr
                      key={row[0] ?? String(i)}
                      style={{
                        backgroundColor: i % 2 === 0 ? "#FAFAF7" : "#F5F0E8",
                        borderTop: "1px solid #E5DDD0",
                      }}
                    >
                      <td
                      ...
                      <td className="px-5 py-3.5" style={{ color: "#4A4A4A" }}>
                        {row.darshan}
                      </td>
                      <td
                        className="px-5 py-3.5 font-mono text-xs"
            ...
            <p className="mt-3 font-body text-xs" style={{ color: "#7A7A7A" }}>
          ...
          >
                    ...
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((n) => (
                        <Star
                          ...
                          style={{
                            color: n <= r.rating ? "#ED872D" : "#E5DDD0",
                          }}
                        />
                      ))}
                    </div>
            ...
            <button
              ...
              style={{ border: "1.5px solid #3C1414", color: "#3C1414" }}
              ...
              {faqs.map((faq, idx) => (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between px-5 py-4 text-left transition-colors"
                    style={{
                      backgroundColor: openFaq === idx ? "#F5F0E8" : "#FAFAF7",
                    }}
                  >
                    <span
                  ...
                  >
                    <div className="relative h-32 overflow-hidden">
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(180deg, transparent 40%, rgba(60,20,20,0.7) 100%)",
                        }}
                      />
                    </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-[130px] space-y-4">
            ...
            <div
              ...
              style={{ border: "1px solid #E5DDD0", backgroundColor: "white" }}
            >
              <div className="px-6 pt-6 pb-4">
                ...
                <p className="font-mono text-sm" style={{ color: "#7A7A7A" }}>
              ...
              <div className="px-6 pb-6 space-y-3">
                ...
                >
                  <Phone className="w-3.5 h-3.5" style={{ color: "#C04000" }} />
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  {
                    icon: (
                      <Phone className="w-4 h-4" style={{ color: "#C04000" }} />
                    ),
                    label: "24/7 Support",
                  },
                  {
                    icon: (
                      <Heart className="w-4 h-4" style={{ color: "#C04000" }} />
                    ),
      ...
      {/* ── Bottom CTA ────────────────────────────────────── */}
      <div className="py-16" style={{ backgroundColor: "#3C1414" }}>
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <a
              href={`https://wa.me/919999999999?text=Hi%20Manya!%20I'd%20like%20to%20plan%20${encodeURIComponent(yatra.name)}.`}
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className="fixed bottom-14 left-0 right-0 z-40 px-4 md:hidden">
        <Link
          to={`/booking/yatra-${slug}`}
          className="block w-full text-center py-4 rounded-xl font-body text-sm font-semibold text-white shadow-lg"
          style={{ backgroundColor: "#3C1414" }}
