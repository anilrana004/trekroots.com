...
export function Navbar() {
  ...
  return (
    <>
      <header
        data-ocid="navbar"
        className="fixed top-0 left-0 right-0 z-50 h-[68px] flex items-center shadow-sm"
        style={{
        ...
        <div className="w-full max-w-[1400px] mx-auto px-6 flex items-center justify-between">
          ...
          >
            ...
            >
              <polygon
                ...
                strokeWidth="2"
              />
              <polygon points="14,9 21,22 7,22" fill="#C04000" opacity="0.3" />
            </svg>
            <span
              className="font-display text-[18px] font-bold tracking-tight truncate"
              style={{ color: "#C04000" }}
            >
              Manya Destination
            </span>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <Link
              ...
              aria-label="Search"
              className="p-2 rounded hover:bg-[#C04000]/10 transition-colors"
              style={{ color: "#C04000" }}
            >
              <Search size={18} />
            </Link>
            <Link
              ...
              className="hidden md:flex items-center gap-1.5 px-4 py-1.5 rounded text-[13px] font-semibold font-body text-white transition-colors"
            ...
            <button
              ...
              aria-expanded={open}
              onClick={toggleMenu}
              className="md:hidden p-2 rounded hover:bg-[#C04000]/10 transition-colors"
              style={{ color: "#C04000" }}
            >
        ...
        >
          {NAV_LINKS.map(({ label, to }) => (
            <Link
              ...
              style={{ color: "#8B3A00", borderColor: "#e8d9bc" }}
            >
              {label}
              <ArrowRight
                size={15}
                style={{ color: "#C04000", opacity: 0.6 }}
              />
            </Link>
          ))}
          <Link
            ...
            className="mt-6 flex items-center justify-center gap-2 px-4 py-3.5 rounded text-[15px] font-semibold font-body text-white transition-colors"
            style={{ backgroundColor: "#C04000" }}
          >
            Plan Your Trip <ArrowRight size={15} />
          </Link>
          <a
            href="https://wa.me/919999999999?text=Hi%20Manya%20Destination!%20I'd%20like%20to%20plan%20a%20trip."
            target="_blank"
            ...
            style={{ color: "#C04000", borderColor: "#C04000" }}
          >
            <svg
              width="18"
              height="18"
