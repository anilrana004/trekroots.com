...
const VOF_JUMP_TABS = [
  ...
  { label: "Inclusions", id: "section-inclusions" },
  { label: "Packing", id: "section-packing" },
  { label: "How to Reach", id: "section-how-to-reach" },
] as const;
...
const INCLUDED = [
  ...
  "TrekRoots trekking T-shirt & bandana",
];
  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="no-retro w-full text-left py-5 px-0 flex items-start gap-4 group"
        aria-expanded={open}
        data-ocid={`itinerary.item.${item.day}.toggle`}
      >
        <div
          className="shrink-0 w-10 h-10 rounded-full flex items-center justify-center font-body font-bold text-[13px] mt-0.5"
          style={
            open
              ? { backgroundColor: "#F7F7F7", color: "#FFE082" }
      ...
      >
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ backgroundColor: "#F5F5F5", color: "#FFC107" }}
          >
            {item.icon}
          </div>
          <h4
  ...
  return (
    ...
    >
      ...
      <div className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {PRICE_TIERS.map((t, i) => (
              <button
                ...
                style={{
                  backgroundColor: tier === i ? "#FFC107" : "#F5F5F5",
                  color: tier === i ? "#FFE082" : "#A0A0A0",
                  border:
                    tier === i ? "1px solid #F5F5F5" : "1px solid #E8E8E8",
                }}
              >
                {t.label}
              </button>
        ...
        >
          <span className="font-body text-[13px]" style={{ color: "#666666" }}>
            Total Estimate
          </span>
          <span
        ...
        {/* CTA Buttons */}
        <Link
          href="/booking/valley-of-flowers"
      ...
      <div className="p-5 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2">
            {PRICE_TIERS.map((t, i) => (
              <button
                ...
                style={{
                  backgroundColor: tier === i ? "#F5F5F5" : "#fff",
                  color: tier === i ? "#FFE082" : "#A0A0A0",
                  border:
                    tier === i ? "1px solid #F5F5F5" : "1px solid #E8E8E8",
                }}
          ...
          <div className="space-y-2">
            {[
              ...
              <label
                ...
                style={{
                  backgroundColor: extras[addon.key] ? "#FFF3E8" : "#F5F5F5",
                  border: `1px solid ${extras[addon.key] ? "#FFD54F" : "#2A2A2A"}`,
                }}
              >
        ...
        >
          ...
          <div
            ...
            style={{ color: "#1A1A1A", borderTop: "1px solid #E8E8E8" }}
          >
            <span>Total Estimate</span>
            <span>₹{finalTotal.toLocaleString("en-IN")}</span>
          </div>
          <p className="font-body text-[10px]" style={{ color: "#666666" }}>
...
export default function ValleyOfFlowersPage() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      let current: string = VOF_JUMP_TABS[0].label;
      for (const tab of VOF_JUMP_TABS) {
  ...
  return (
    <div style={{ backgroundColor: "#FFFFFF" }}>
        ...
        >
          <div
            ...
            style={{
              ...
              borderTop: "1px solid rgba(255,193,7,0.25)",
            }}
          >
            {[
              {
      ...
      {/* Jump-to-section — sticky; rises to top when header hides on phone scroll */}
      <div
        className="detail-section-nav hide-scrollbar overflow-x-auto"
        data-ocid="vof.section_nav"
        style={{
          backgroundColor: "#FFFFFF",
          borderBottom: "1px solid #E8E8E8",
        }}
      >
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex gap-2 py-2.5 min-w-max">
            {VOF_JUMP_TABS.map((tab) => (
              <button
                key={tab.id}
                type="button"
                data-ocid={`vof.tab.${tab.label.toLowerCase().replace(/ /g, "_")}`}
                onClick={() => {
                ...
                style={{
                  color: activeTab === tab.label ? "#FFC107" : "#555555",
                }}
              >
                {tab.label}
              </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-12 xl:gap-16">
          ...
          <div className="min-w-0">
            ...
            <section
              ...
              className="py-10 border-t"
              style={{ borderColor: "#E8E8E8" }}
              data-ocid="vof.pack.section"
            >
              <SectionLabel>Gear Checklist</SectionLabel>
            ...
            {/* Practical Details / How to Reach */}
            <section
              id="section-how-to-reach"
              className="py-10 border-t"
              style={{ borderColor: "#E8E8E8" }}
        ...
        >
          <div className="flex-1">
            ...
            <p
              ...
              style={{ fontStyle: "italic", color: "#FFE082" }}
            >
              ₹18,500
            </p>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="no-retro px-4 py-3 rounded-xl font-body font-semibold text-[13px] transition-all hover:opacity-90 flex items-center justify-center"
            style={{ backgroundColor: "#25D366", color: "#fff" }}
